  ...
  describe "generates valid signature for each request type" do
    describe "GET" do
      it "ignores nil data" do
        signature = Lockme::SignedRequest.signature('GET', 'reservation', nil)
    ...
    describe "DELETE" do
      it "ignores nil data" do
        signature = Lockme::SignedRequest.signature('DELETE', 'reservation/1234', nil)
    ...
    describe "POST" do
      it do
        signature = Lockme::SignedRequest.signature('POST', 'reservation/1234', '{"first_name":"John"}')
    ...
    describe "PUT" do
      it do
        signature = Lockme::SignedRequest.signature('PUT', 'reservation/1234', '{"first_name":"John"}')
